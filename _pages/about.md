...
I am an undergraduate student majoring in **Mathematics & Applied Mathematics** at the [University of Nottingham Ningbo China (UNNC)](https://www.nottingham.edu.cn/). My passion lies in the intersection of rigorous mathematical theory and practical algorithmic implementation.
...
You can find my publications on <a href='https://scholar.google.com/citations?user=x81ITIYAAAAJ'>Google Scholar <img src="https://img.shields.io/endpoint?url={{ url | url_encode }}&logo=Google%20Scholar&labelColor=f6f6f6&color=9cf&style=flat&label=citations"></a>.


# 🔥 News
- *2025.03*: &nbsp;🎉🎉 Our paper **TC-SSA: Token Compression via Semantic Slot Aggregation** is now available on arXiv!
...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">arXiv 2025</div><img src='images/tc_ssa.png' alt="TC-SSA" width="100%"></div></div>
...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">arXiv 2025</div><img src='images/pathoselect.png' alt="PathoSelect" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
...
# 📖 Educations
- *2024.09 - 2028.06 (expected)*, B.Sc. in Mathematics & Applied Mathematics, **University of Nottingham Ningbo China (UNNC)**. 
